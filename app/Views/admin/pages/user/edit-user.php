                    ...
                    <div class="tab_container">
                        <div id='tab1' class="tab_content pd0">
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    <span class="oneTwo"><input value="<?= $user['name']  ?>" name="name" id="param_name" _autocheck="true" type="text" /></span>
                            ...
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    <span class="oneTwo"><input value="<?= $user['email']  ?>" name="email" id="param_email" _autocheck="true" type="email" /></span>
                                    <span name="name_autocheck" class="autocheck"></span>
                                    <div name="name_error" class="clear error"></div>
                                </div>
                                <div class="clear"></div>
                            ...
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    <span class="oneTwo"><input value="" name="password" id="param_password" _autocheck="true" type="password" /></span>
                                    <span name="name_autocheck" class="autocheck"></span>
                                    <div name="name_error" class="clear error"></div>
                                </div>
                                <div class="clear"></div>
                            ...
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    <span class="oneTwo"><input value="<?= $user['phone'] ?>" name="phone" id="param_phone" _autocheck="true" type="text" /></span>
                                    <span name="name_autocheck" class="autocheck"></span>
                                    <div name="name_error" class="clear error"></div>
                                </div>
                                <div class="clear"></div>
                            ...
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    <span class="oneTwo"><input value="<?= $user['address'] ?>" name="address" id="param_address" _autocheck="true" type="text" /></span>
                                    <span name="name_autocheck" class="autocheck"></span>
                                    <div name="name_error" class="clear error"></div>
                                </div>
                                <div class="clear"></div>
                            ...
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    <span class="oneTwo"><input  type="checkbox" />Thay đổi mật khẩu</span>
                                    <span name="name_autocheck" class="autocheck"></span>
                                    <div name="name_error" class="clear error"></div>
                                </div>
                                <div class="clear"></div>
