<div id="rightSide">
    ...
    <div class="wrapper">
        ...
        <form id="form" class="form" enctype="multipart/form-data" method="post" action="admin/List-Category/EditCategory/<?= $category['id'] ?>">
            <fieldset>

                <div class="formRow">
                    <label for="param_name" class="formLeft">Tên:<span class="req">*</span></label>
                    <div class="formRight">
                        <span class="oneTwo"><input type="text" _autocheck="true" id="param_name" value="<?= $category['name'] ?>" name="name"></span>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo"><input type="text" _autocheck="true" id="param_sort_order" value="<?= $category['sort_order'] ?>" name="sort_order"></span>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneTwo"><input type="text" _autocheck="true" id="param_sort_order"  value="<?= $category['meta_key'] ?>"  name="meta_key"></span>
                        <span class="autocheck" name="sort_order_autocheck"></span>
                        <div class="clear error" name="sort_order_error"></div>
                    </div>
                    <div class="clear"></div>
