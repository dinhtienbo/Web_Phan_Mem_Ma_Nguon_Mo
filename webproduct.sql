...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 28, 2021 lúc 01:21 PM
...
INSERT INTO `admin` (`id`, `email`, `password`, `name`, `admin_group_id`) VALUES
(8, 'dinhtienbo2000@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Đinh Tiến Bộ', 0);
...
(35, 'Quần thể thao', '', '', 'Quan_the_thao', 33, 10),
(34, 'Quần Âu', '', '', 'Quan_Au', 33, 15),
(31, 'Áo khoác', '', '', 'Ao_khoac', 27, 5),
(33, 'Quần', '', '', 'Quan', 0, 8),
(32, 'Áo thun dài tay', '', '', 'Ao_Thun_Dai_Tay', 27, 6),
(29, 'Áo polo', '', '', 'Ao_po_lo', 27, 3),
(30, 'Áo len', '', '', 'Ao_len', 27, 4),
(27, 'Áo', '', '', 'Ao', 0, 1),
(28, 'Áo sơ mi', '', '', 'Ao_so_mi', 27, 2),
(36, 'Phụ kiện', '', '', 'Phu_kien', 0, 1),
(37, 'Trẻ em', '', '', 'Tre_em', 0, 5),
(38, 'Đàn ông', '', '', 'Dan_ong', 0, 1);
...
CREATE TABLE `order` (
  ...
  `amount` decimal(15,1) NOT NULL DEFAULT 0.0,
...
CREATE TABLE `product` (
  ...
  `created` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
...
(50, 28, 'Áo sơ SM05', 0, '132.0', '   ', 22, '5_1.jpg', '5_2.jpg,5_3.jpg', '2021-08-03 15:18:53', 9, 'SM05', '', '', 0, 12, 0, 0, '', '', '', '0'),
(51, 28, 'Áo sơ SM06', 0, '1500.0', ' ', 500, '6_1.jpg', '6_2.jpg,6_3.jpg', '2021-08-03 15:19:34', 21, 'SM06', '', '', 0, 8, 0, 0, '', '', '', '0'),
(49, 28, 'Áo sơ SM04', 0, '132.0', '  ', 5, '4_1.jpg', '4_2.jpg,4_3.jpg', '2021-08-03 15:18:11', 1, 'SM04', '', '', 0, 0, 0, 0, '', '', '', '0'),
(47, 28, 'Áo sơ SM02', 0, '13.0', '  ', 0, '2_1.jpg', '2_2.jpg,2_3.jpg', '2021-08-03 15:17:16', 3, 'SM02', '', '12', 0, 0, 0, 0, '', '', '', '0'),
(48, 28, 'Áo sơ SM03', 0, '132.0', ' ', 50, '3_1.jpg', '3_2.jpg,3_3.jpg', '2021-08-03 15:17:49', 0, 'SM03', '', '', 0, 1, 0, 0, '', '', '', '0'),
(46, 28, 'Áo sơ SM01', 0, '12.0', ' ', 1, '1_1.jpg', '1_2.jpg,1_3.jpg', '2021-08-03 15:16:42', 8, 'SM01', '', '12', 0, 0, 0, 0, '', '', '', '0');
...
CREATE TABLE `transaction` (
  ...
  `created` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(30, 0, 2, 24, 'dinh@gmail.com', 'dinht@gmail.com', '0396329108', '1000.0', '', '', '', '', '2021-08-03 23:21:25'),
(31, 0, 2, 24, 'dinh@gmail.com', 'dinht@gmail.com', '0396329108', '1000.0', '', '', '', '', '2021-08-03 23:23:24'),
(32, 0, 0, 24, 'dinh@gmail.com', 'dinht@gmail.com', '0396329108', '2220.0', 'offline', '', '', '', '2021-08-03 23:24:49'),
(33, 0, 1, 0, 'Đinh Tiến Bộ', 'dinhtienbo2500@gmail.com', '0396329108', '110.0', 'offline', '', '', '', '2021-08-10 15:16:30'),
(34, 0, 0, 0, 'Đinh Tiến Bộ', 'dinhtienbo03132@gmail.com', '0396329108', '4000.0', '', '', '', '', '2021-08-10 15:56:24'),
(35, 0, 0, 0, 'Đinh Tiến Bộ', 'dinhtienbo2000@gmail.com', '0396329108', '2914.0', '', '', '', '', '2021-08-10 16:09:31'),
(36, 0, 0, 0, 'Đinh Tiến Bộ', 'dinhtienbo2000@gmail.com', '0396329108', '2694.0', '', '', '', '', '2021-08-10 16:13:29'),
(43, 0, 0, 24, 'dinh@gmail.com', 'dinht@gmail.com', '1256156564', '3220.0', 'offline', '', '', '', '2021-08-23 22:54:20'),
(41, 0, 1, 0, 'Đinh Tiến Bộ', 'dinhtienbo2000@gmail.com', '0396329108', '2000.0', '', '', '', '', '2021-08-18 21:29:56'),
(42, 0, 2, 34, 'alo', 'alo@gmail.com', '', '110.0', '', '', '', '', '2021-08-20 23:37:45'),
(44, 0, 0, 0, '123', '111@gmail.com', '1', '1072.0', 'paypal', '', '', '', '2021-08-26 21:24:54');
...
(24, 'dinh@gmail.com', 'dinht@gmail.com', '1256156564', 'Cơ sở 1 đại học Công Nghiệp Hà Nội', 'e10adc3949ba59abbe56e057f20f883e', 0),
(25, 'nida', 'nida@gmail.com', '0396329108', 'Cơ sở 1 đại học Công Nghiệp Hà Nội', '$2y$10$F2S7smbTCrTUCwTT32aWPe043mcbI/Z52', 0),
(20, 'Đinh Tiến Bộ', 'yasuo@gmail.com', '0396329108', 'Cơ sở 1 đại học Công Nghiệp Hà Nội', 'e10adc3949ba59abbe56e057f20f883e', 1627214459),
(30, 'dinhtienbo2@gmail.com', 'dinhtienbo2@gmail.com', '0396329108', 'Cơ sở 1 đại học Công Nghiệp Hà Nội', 'e10adc3949ba59abbe56e057f20f883e', 0),
(31, 'Đinh Tiến Bộ', 'da@gamil.com', '', '', 'e10adc3949ba59abbe56e057f20f883e', 0),
(32, 'long', 'long@gmail.com', '', '', 'e10adc3949ba59abbe56e057f20f883e', 0),
(34, 'alo', 'alo@gmail.com', '', '', 'e10adc3949ba59abbe56e057f20f883e', 0),
(35, 'alo132', 'alo11@gmail.com', '', '', 'e10adc3949ba59abbe56e057f20f883e', 0),
(36, 'longbeo', 'longbeo@gmail.com', '123123', '1', 'e10adc3949ba59abbe56e057f20f883e', 0);
