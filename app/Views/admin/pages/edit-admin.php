<div id="rightSide">
    ...
    <div class="wrapper">
        ...
        <form class="form" id="form" action="admin/List-Admin/EditAdmin/<?=$admins['id']?>" method="post">
            <fieldset>
                <div class="widget">
                    <div class="title">
                    ...
                    <div class="tab_container">
                        <div id='tab1' class="tab_content pd0">
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    <span class="oneTwo"><input value="<?= $admins['name'] ?>" name="name" id="param_name" _autocheck="true" type="text" /></span>
                            ...
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    <span class="oneTwo"><input value="<?= $admins['username'] ?>" name="username" id="param_password" _autocheck="true" type="text" /></span>
                                    <span name="name_autocheck" class="autocheck"></span>
                                    <div name="name_error" class="clear error"></div>
                                </div>
                                <div class="clear"></div>
                        ...
                        <div class="formSubmit">
                            ...
                            <input type="button" onclick="location.href='admin/List-Admin/Add';" value="Hủy bỏ" class="basic" />
